...
const KevenCard = () => (
    <svg width="270" height="425" fill="rgb(65, 59, 69)" stroke="rgb(65, 59, 69)" className="card keven-card">
        ...
        <rect x="10" y="10" height="405" width="250" fill="white" rx="20" ry="15" fill="white" />
...
const ScheduleCard = () => (
    <svg width="270" height="425" fill="rgb(65, 59, 69)" stroke="rgb(65, 59, 69)" className="card schedule-card">
        ...
        <text x="100" y="70" fontFamily="Ubuntu" fontVariant="small-caps" fontWeight="bold" fontSize="20" >Horaires</text>
